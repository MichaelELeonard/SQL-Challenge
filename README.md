...
The exported file from QuickDBD was imported to PostgreSQL to create the tables of the SQL database.  Data from the six CSV flies was uploaded into the corresponding tables and the constrains were established.  
## Data Analysis
